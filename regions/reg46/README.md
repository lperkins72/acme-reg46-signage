...
This folder is the region-default content layer for `reg46`.
...
- `regions/reg46/data/primary-assets.json`
- `regions/reg46/data/primary.json`
- `regions/reg46/data/footer.json`
- `regions/reg46/data/primaryending.json`
- `regions/reg46/assets/primary/manifest.json`
- `regions/reg46/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg46`.
